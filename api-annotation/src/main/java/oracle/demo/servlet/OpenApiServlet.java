...
/**
 * Original io.swagger.v3.jaxrs2.integration.OpenApiServlet doesn't care about double byte characters
 * This servlet fixes this issue
 * 
 * */
public class OpenApiServlet extends HttpServlet {
    ...
    public static final String APPLICATION_YAML_UTF8 = "application/yaml; charset=utf-8";
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (type.equalsIgnoreCase("yaml")) {
            resp.setContentType(APPLICATION_YAML_UTF8); // CHANGED!! - to fix mojibake
            PrintWriter pw = resp.getWriter();
            pw.write(pretty ? Yaml.pretty(oas) : Yaml.mapper().writeValueAsString(oas));
            pw.close();
        } else {
            resp.setContentType(APPLICATION_JSON_UTF8); // CHANGED!! - to fix mojibake
            PrintWriter pw = resp.getWriter();
